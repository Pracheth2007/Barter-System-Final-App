    ...
    <Modal
      ...
      <View style={{flex: 1,backgroundColor: "#fff"}}>
        ...
        <View style={{flex:0.2,justifyContent:'center',alignItems:'center'}}>
            <Text style={{fontSize:RFValue(10),fontWeight:"bold",color:"#32867d"}}> SIGN UP </Text>
          </View>
    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer}>
          ...
          <Text style={{color:'red'}}> A Trading Method </Text>
        </View>
        <View style={styles.buttonContainer}>
          <Text style={{color:'blue', fontSize:18, fontWeight:'bold',marginLeft:600}}>USERNAME</Text>
          ...
          <Text style={{color:'blue', fontSize:18, fontWeight:'bold',marginLeft:600}}>PASSWORD</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
